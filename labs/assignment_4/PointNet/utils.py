...
class setting:
    dataset = "/Users/fangjiacong/Desktop/Semester 3.2/Introduction_to_Computer_Vision-wh-2025Spring-PKU/labs/assignment_4/data/shapenetcore_partanno_segmentation_benchmark_v0"
    batchSize = 32
    num_points = 1024
    workers = 1
    nepoch = 2
